...
export default function About() {
  return (
    <div className="min-h-screen bg-slate-50 pb-20">
      {/* Visual Header */}
      <div className="bg-cls-navy py-24 text-center mt-0">
        <h1 className="text-4xl md:text-5xl font-bold text-white tracking-tight mb-6">About <span className="text-cls-gold">CLS</span></h1>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 mb-16 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-32 h-32 bg-cls-gold/10 rounded-bl-full"></div>
          <h2 className="text-3xl font-bold text-cls-navy mb-6">신내동 최고의 교육 파트너</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 bg-slate-50 p-6 rounded-xl border border-slate-100">
            <div>
              ...
              <p className="font-semibold text-cls-navy">신내동 영창빌딩 7층</p>
            </div>
            <div>
              <p className="text-sm text-gray-400 mb-1">대상</p>
              <p className="font-semibold text-cls-navy">초등, 중등, 고등</p>
            </div>
            <div>
              <p className="text-sm text-gray-400 mb-1">과목</p>
              <p className="font-semibold text-cls-navy">국 · 영 · 수 · 과</p>
            </div>
            <div>
              <p className="text-sm text-gray-400 mb-1">특징</p>
              <p className="font-semibold text-cls-navy">내신분석, 윈터스쿨</p>
            </div>
          </div>
        </div>

        {/* Philosophy Details */}
        <h3 className="text-2xl md:text-3xl font-bold text-cls-navy text-center mb-12">CLS에듀케이션 <span className="text-cls-gold">교육 철학</span></h3>
        ...
        <div className="space-y-6 mb-20">
          <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow flex flex-col md:flex-row gap-8 items-center border border-slate-100">
            <div className="w-16 h-16 shrink-0 bg-cls-gold text-white rounded-full flex items-center justify-center text-2xl font-bold shadow-md">1</div>
            <div>
              <h4 className="text-xl font-bold text-cls-navy mb-3">첫 만남부터 밀착 케어까지: "1:1 맞춤형 로드맵"</h4>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow flex flex-col md:flex-row gap-8 items-center border border-slate-100">
            <div className="w-16 h-16 shrink-0 bg-cls-navy text-white rounded-full flex items-center justify-center text-2xl font-bold shadow-md">2</div>
            <div>
              <h4 className="text-xl font-bold text-cls-navy mb-3">CLS만의 특별함: "공부 근육을 기르는 관리 시스템"</h4>
              <p className="text-gray-600 leading-relaxed font-light break-keep">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow flex flex-col md:flex-row gap-8 items-center border border-slate-100">
            <div className="w-16 h-16 shrink-0 bg-cls-gold text-white rounded-full flex items-center justify-center text-2xl font-bold shadow-md">3</div>
            <div>
              <h4 className="text-xl font-bold text-cls-navy mb-3">지역 학교 최적화: "성장하는 안정적 학습 공동체"</h4>
              <p className="text-gray-600 leading-relaxed font-light break-keep">
        ...
        {/* Promise Section */}
        <div className="bg-cls-navy text-white rounded-3xl p-10 md:p-16 mb-20 text-center shadow-xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h3 className="text-3xl font-bold mb-8 text-cls-gold">CLS에듀케이션의 약속</h3>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-8 md:p-12 border border-slate-100">
          <h3 className="text-2xl font-bold text-cls-navy mb-8 border-b pb-4">찾아오시는 길</h3>
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <div className="space-y-6">
              <div>
                <h4 className="font-bold text-cls-navy text-lg mb-2">주소 (Address)</h4>
                <p className="text-gray-600 font-light">서울특별시 중랑구 봉화산로 218 영창빌딩 7층</p>
              </div>
              <div>
                <h4 className="font-bold text-cls-navy text-lg mb-2">교통편 (Transport)</h4>
              ...
              <div>
                <h4 className="font-bold text-cls-navy text-lg mb-2">상담 문의 (Contact)</h4>
